...
struct devinfo sataInfo[]={
	{.name="SATA1", .phyaddr=0XFD6E0AC0, .shift=1, .base=NULL},
	{.name="SATA2", .phyaddr=0XFD6E0B00, .shift=1, .base=NULL},
};
...
static void hwinit(void)
{
	...
	beeperInfo.base = ioremap(beeperInfo.phyaddr, 4);
}
...
{
	printk("DH2600 sata & beeper init\n");
	sata_io_num = 2;	//get_product_sata_num(__func__);
