 ...
 * Author:Swing.Chen
 * date:2024/8/2
 * Description: For iDX6011 && iDX6012
...
#define DEVICE_FAN1_MODE	0x9c
#define DEVICE_FAN1_PWM		0x9d
#define DEVICE_FAN2_MODE	0x9e
#define DEVICE_FAN2_PWM		0x9f
#define DEVICE_FAN1_SPEED_MBS	0x96
#define DEVICE_FAN1_SPEED_LSB	0x97
#define DEVICE_FAN2_SPEED_MBS	0x98
#define DEVICE_FAN2_SPEED_LSB	0x99

#define EC_PWR_ENABLE		0xAA
#define EC_PWR_VALUE		0xA9
#define AC_POWER_LOST_VAL	0x66
#define AC_POWER_LOST_ON	0x8f
#define AC_POWER_LOST_OFF	0x8e
#define G3_WAKEUP_ADR		0xA6
#define LAN_WAKEUP_ADR		0xA7
			...
			loff_t *ppos)
{
	char tmpbuf[128]={0};
	int rc = 0;
	unsigned long fan1_val, fan2_val;
	int cnt = 0;
	u8 tmp1, tmp2;
	ec_request_ports();
...
static int __init functions_init(void)
{
	...
	if(strcmp(product,"iDX6011") && strcmp(product,"iDX6012"))
		return -ENODEV;
