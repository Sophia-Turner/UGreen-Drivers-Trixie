...
static int __init ledtrig_normal_n76e003_init(void)
{
#if 0
...
module_init(ledtrig_normal_n76e003_init);

static void __exit ledtrig_normal_n76e003_exit(void)
{
 led_trigger_unregister(&normal_led_trigger);
}

module_exit(ledtrig_normal_n76e003_exit);
